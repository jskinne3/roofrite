...
- **Ridge:** The very top peak of your roof. It’s the _highest horizontal line_ where two opposing roof slopes meet.
- **Hip:** The downward-sloping ridge that is formed where two adjacent roof sections meet at an angle; the hip spans from the _peak_ to the _eave_.
- **Valley:** The _V-shaped channel_ formed where two downward-sloping roof sections intersect. Because it channels water runoff, proper sealing here is crucial.
- **Flat Roof:** Also called a _“low-slope” roof_, this roofing surface type actually features a slight pitch—typically around 1/4 of an inch per foot—to ensure that rainwater is directed towards the gutters, scuppers, or another type of drainage system.
- **Gable / Rake:** The section of an outside wall that sits right beneath the peak of a sloping roof. It’s _the “triangle” atop the square_ in a typical kid’s drawing of a house.
- **Gable End:** Much like a gable (or “rake”), a gable end includes the triangular section of the outside wall, but it includes the _whole face_ of the structure below the roof, too.
- **Hipped Edge:** A side (or _“facet”_) of the roof that includes a hipped joint.
...
- **Fascia:** The _vertical board_ that runs horizontally along your roof’s lower edge, capping the ends of rafters. The fascia connects the top surface of your roof to its _soffit_, located on the underside of the eave. It serves as the main support for your gutters and provides a critical defense against moisture and pests.
- **Skylight:** A specialized window installed _directly into your roof_; a skylight invites natural light and good ventilation into your home.
